            ...
            <form onSubmit={handleSubmit} >
                ...
                <label className={`${styles.label}`} htmlFor="email">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        id="password"
                        placeholder="use@#!% for strong password"
                    ...
                    {!show ? (
                        <AiOutlineEyeInvisible
                            className="absolute bottom-3 right-2 z-1 dark:text-white text-black cursor-pointer"
                            size={20}
                ...
                <h5 className="text-center dark:text-white text-black pt-4 font-Poppins text-[14px]">
                    ...
                    <span
                        className="text-[#2190ff] pl-1 curssor-pointer"
