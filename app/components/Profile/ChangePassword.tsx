...
//                     <div className="w-[100%] 800px:w-[60%] mt-2">
//                         <label
//                             className="block pb-2 w-[900px] text-black dark:text-[#fff]"
//                         >
//                             Enter your old password
//                         </label>
//                         <input
//                             type="password"
//                             className={`${styles.input} !w-[95%] mb-4 800px:mb-0 dark:border-white border-black text-black dark:text-[#fff]`}
//                             required
//                             value={oldPassword}
//                             onChange={(e) => setOldPassword(e.target.value)}
//                         />
